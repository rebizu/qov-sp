...
export class QovDecoder {
  ...
  private readChunkHeader(): QovChunkHeader {
    ...
    return { chunkType, chunkFlags, chunkSize, timestamp };
  }
    ...
    while (this.pos < this.data.length) {
      ...
      switch (chunkHeader.chunkType) {
        ...
        case QOV_CHUNK_KEYFRAME: {
          ...
          console.log(`[Decoder] Decoding keyframe ${frameNumber}, YUV: ${isYuvChunk}...`);
        ...
        case QOV_CHUNK_PFRAME: {
          const isYuvChunk = (chunkHeader.chunkFlags & 0x01) !== 0;
          console.log(`[Decoder] Decoding P-frame ${frameNumber}, YUV: ${isYuvChunk}...`);
